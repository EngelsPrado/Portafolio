				...
				<section className="row servicios-index" data-aos="fade-up">
					...
					<article className="col-12 col-lg-4 servicio-individual">
						...
						<p className="parrafo">
							...
							Laudantium consequatur, vel nesciunt pariatur itaque at!
							Dolores vero, similique harum blanditiis veniam dolore cumque
							adipisci voluptate iure totam asperiores, officiis aspernatur!
						</p>
					</article>
					<article className="col-12 col-lg-4 servicio-individual">
