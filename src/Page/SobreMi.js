				...
				<section className="container sobremi">
					...
					<div className="row" data-aos="fade-up">
						...
						<div className="col-12 col-md-4 col-lg-6">
							...
							<div className="bar">
								<div className="skill">HTML5 / CSS3 / JQUERY</div>
							...
							<div className="bar">
								<div className="skill">Vanilla JavaScript</div>
								<div className="bar-outer">
									<div className="speech-bubble js">50%</div>
							...
							<div className="bar">
								...
								<div className="bar-outer">
									<div className="speech-bubble re">40%</div>
							...
							<div className="bar">
								...
								<div className="bar-outer">
									<div className="speech-bubble wp">80%</div>
